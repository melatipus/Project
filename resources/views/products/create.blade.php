      ...
      <div class="row mb-3">
        <div class="col-md-6">
          ...
          <div class="input-group">
            ...
            <input type="text" class="form-control @error('normal_price') is-invalid @enderror" id="normal-price" name="normal_price" value="{{ old('normal_price') }}">
            @error('normal_price')
            <div class="invalid-feedback text-danger">
              {{ $message }}
            </div>
        ...
        <div class="col-md-6">
          ...
          <div class="input-group">
            <span class="input-group-text">Rp</span>
            <input type="text" class="form-control @error('member_price') is-invalid @enderror" id="member-price" name="member_price" value="{{ old('member_price') }}">
            @error('member_price')
            <div class="invalid-feedback text-danger">
              {{ $message }}
            </div>
